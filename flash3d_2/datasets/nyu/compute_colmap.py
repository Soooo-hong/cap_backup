...
DATA_PATH = Path("/home/shk00315/capston2/flash3d/data/nyuv2")
...
def get_nyu_test_sequences():
    labeled_dir = Path("/home/shk00315/capston2/flash3d/data/nyuv2_labeled") 
    #test_squences.txt가 존재해야됨
...
def compute_sfm(seq_name):
    ...
    out_root_dir = Path("/home/shk00315/capston2/flash3d/data/nyuv2_colmap")
