...
import random
import json
from GaussianObject.utils.system_utils import searchForMaxIteration
...
from GaussianObject.arguments import ModelParams
from GaussianObject.utils.camera_utils import cameraList_from_camInfos, camera_to_JSON
import time
...
class Scene:
    ...
    def __init__(self, fine_visual_hull,image_name, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=False, resolution_scales=[1.0], extra_opts=None, load_ply=None):
        ...
        """
        self.model_path = '/home/shk00315/cap_2/flash3d_2/result_images/initial_gaussian_with_visual_hull' # type: ignore
